...
const CollectorPerformanceModal: React.FC<CollectorPerformanceModalProps> = ({
  ...
  return (
    ...
    >
      <div
        className="bg-white rounded-3xl shadow-2xl w-full max-w-[90%] mx-auto transform transition-all duration-300 ease-in-out max-h-[90vh] flex flex-col"
      ...
      >
        <>
          ...
          {/* Scrollable Content */}
          <div className="flex-grow overflow-y-auto custom-scrollbar px-6 pb-6 m-5">
            {/* Métricas Principais */}
